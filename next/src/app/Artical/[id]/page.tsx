        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
            ...
            >
              ...
              {post.email && (
                <Box>
                  ...
                  <MuiLink href={`mailto:${post.email}`}>{post.email}</MuiLink>
                </Box>
              )}
          ...
          <Box sx={{ mb: 3 }}>
            <Typography
              variant="subtitle1"
              fontWeight="medium"
              sx={{ mb: 2, pb: 1, borderBottom: "1px solid rgba(0,0,0,0.1)" }}
            >
              活動與組織資訊
            </Typography>
            <Box
            ...
            >
              ...
              <Typography variant="body2">
                <strong>活動期間：</strong>
                {post.eventStart ? formatDate(post.eventStart) : "未提供"}{" "}
